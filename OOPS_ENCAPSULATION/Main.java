...
Book bb=new 
Book(bookname,isbnnumber,publishername,totalprice,customersnumber);
...
private int n;
public Book(String bookname,int isbnnumber,String publishername,float 
totalprice,int n) {
...
{
price2=(getTotalprice())-
(getTotalprice()*((float)75/(float)100));
price2_2=price2_2+price2;
}
if(c[i].getCustomertype()=='I')
{
  price3=(getTotalprice())-
(getTotalprice()*((float)90/(float)100));
